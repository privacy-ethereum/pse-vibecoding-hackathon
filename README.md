...
|---|---------|------|-------------|------|------|
| 1 | **Vibe Circuit** | Sora Suegami, Nam Ngo | Claude Code plugin for vibe-coding ZK circuits and generating Lean proofs for programmable cryptography | [GitHub](https://github.com/SoraSuegami/vibe-circuit) | [Slides](https://docs.google.com/presentation/d/1a3iog_WDDiPH1gxT1Up_5dTiz9aMO0KehtldY5OxJfw/edit?usp=sharing) |
...
| 6 | **Seal** | Andrew Morris | Local daemon that serves verified, content-addressed web app bundles over HTTPS — protecting users from unverifiable web frontends | [GitHub](https://github.com/voltrevo/seal) | [Video](https://drive.google.com/file/d/1II_BRJEgMWlXWJnarePmH_4AR0qfI1pl/view?usp=drivesdk) |
